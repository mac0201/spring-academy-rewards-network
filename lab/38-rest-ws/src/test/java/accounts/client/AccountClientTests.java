...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
			...
			// -16: Try to retrieve the newly created Beneficiary again.
	...
	@Test
	void testConflictResponseReturnedWhenAccountWithExistingNumberCreated() {
		Account account1 = new Account("12345", "John Doe");
		Account account2 = new Account("12345", "Bob Doe");

		String url = BASE_URL + "/accounts";

		HttpClientErrorException exception = assertThrows(HttpClientErrorException.class, () -> {
			URI location = restTemplate.postForLocation(url, account1);
			assertNotNull(location);
			URI location2 = restTemplate.postForLocation(url, account2);
